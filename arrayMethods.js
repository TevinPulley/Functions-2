...
const evenNumbers = mixedNumbers.filter(function (value) {
  return value % 2 === 0;
});

// const evenNumbers = mixedNumbers.filter((value) => value % 2 === 0);
...
const myStrongest = monstersInYourPocket.filter((num) => num > 200);
...
/*
  Use a higher order method to get all the order totals after adding in the sales tax (given to you as a tax rate, hint: you'll need to do some 
  multiplication). Your answer should be an array of numbers, one total for each order.
*/
