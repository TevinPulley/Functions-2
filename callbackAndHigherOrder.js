...
const last = (arr, func) => func(arr[6]);
...
const contains = (arr, nm, cb) => {
  if (arr.includes(nm) === true) {
    cb(true);
  } else {
    cb(false);
  }
...
/*
  Write a function called getUserById that takes in three parameters: an array of objects (users), an id and a callback, and searches for the 
...
const addTwentytwo = addingFactory(10);
